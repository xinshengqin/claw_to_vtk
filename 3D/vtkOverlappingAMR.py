...
class vtkOverlappingAMR(object):
    ...
    # TODO: define other writing functions, like binary
...
class vtkAMRBlock(object):
    r"""
    A vtkAMRBlock contains all amr_box (grids) of the same level.
    """
